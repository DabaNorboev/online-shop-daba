    ...
    <div class="row">
        <form action="/order" method="post">
            ...
            <div class="col-5 col order">
                ...
                <div>
                    <p class="prod-description inline"><?php echo $product['name'] ?><div class="qty inline"><span class="smalltxt">x</span> <?php echo $product['quantity'] ?></div><div class="qty inline"><span class="smalltxt right-div"><?php echo $product['sum'] ?></span> </div></p>
                </div>
                <?php endforeach; ?>
